...
public class InvoiceService {
    ...
    public Page<InvoiceDTO> list(Long pacienteId, int page, int size){
        if(pacienteId != null){
            return repo.findByPacienteId(pacienteId, PageRequest.of(page, size)).map(InvoiceMapper::toDTO);
        }
    ...
    public InvoiceDTO create(InvoiceDTO dto){
        ...
        InvoiceMapper.updateEntity(e, dto);
        return InvoiceMapper.toDTO(repo.save(e));
    }
